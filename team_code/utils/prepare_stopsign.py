...
for num in num_list:
    if num == 5:
        ...
        routes = "leaderboard/data/training_routes/routes_town" + str(num).zfill(2) +"_tiny.xml"
...
for num in num_list:
    if num == 5:
        ...
        routes =  "leaderboard/data/training_routes/routes_town" + str(num).zfill(2) +"_short.xml"
