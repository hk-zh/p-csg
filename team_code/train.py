...
parser.add_argument('--tl_indicator_loss_w', type=float, default=0.3, help='weight of traffic light indicator loss')
parser.add_argument('--ss_indicator_loss_w', type=float, default=0.2, help='weight of stop sign indicator loss')
parser.add_argument('--feature_alignment_w', type=float, default=0.1, help='the weight of the feature alignment loss')
parser.add_argument('--lambda1', type= float, default=0.1, help='weight of red light penalty')
parser.add_argument('--lambda2', type= float, default=0.01, help='weight of speed penalty')
parser.add_argument('--lambda3', type= float, default=0.05, help='weight of stop sign penalty')
parser.add_argument('--speed_lb', type= float, default=3.0, help='speed lower bound to avoid punishment')
