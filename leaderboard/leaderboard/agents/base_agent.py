...
class BaseAgent(autonomous_agent.AutonomousAgent):
    ...
    def save(self, near_node, far_node, near_command, steer, throttle, brake, target_speed, tick_data):
        ...
        data = {
                ...
                'walker_present': self._walker_present,
                'light_present': self._light_present,
                'stop_sign_present': self._stop_sign_present,
                'light_near': self._light_near,
                'stop_sign_near': self._stop_sign_near,
